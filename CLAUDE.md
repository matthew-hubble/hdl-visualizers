...
- Ensure `marimo` is installed in the uv environment for Marimo Notebook compatibility.
- Use `tqdm` to track long-running loops on the command line. The `description` of the progress bar should be contextually sensitive.
...
- **MUST** make raw table column widths spaced equally
- **MUST** wrap text at 100 characters
...
**Remember:** Prioritize logical and maintainable code over cleverness.